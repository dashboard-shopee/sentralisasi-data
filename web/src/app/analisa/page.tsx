...
export default async function Page({ searchParams }: { searchParams: SP }) {
  ...
  return (
    <div className="max-w-[1400px] xl:max-w-[1600px] w-full mx-auto">
      ...
      <ServerTable kind="iklan" filter={ft} columns={COLS} defaultSort="omzetIklan" pageSize={50} editKey={canEdit ? "analisa-setting" : undefined} trendKind="analisa" options={options} />
    </div>
  );
}
