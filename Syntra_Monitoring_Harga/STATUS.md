...
**Campaign PARKIR total** — satu-satunya jalan realistis: automasi KLIK UI beneran (DrissionPage klik tombol asli, bukan fetch/API) biar signature Shopee ke-generate natural. Belum dikerjain — nunggu keputusan owner (worth it vs skip, given cadence-nya cuma pas tanggal kembar).
